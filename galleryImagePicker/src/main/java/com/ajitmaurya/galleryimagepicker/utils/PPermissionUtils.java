package com.ajitmaurya.galleryimagepicker.utils;
...
public class PPermissionUtils {
    ...
    public static boolean hasStoragePermissions(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
             if (ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED) {
                    activity.requestPermissions(new String[]{Manifest.permission.READ_MEDIA_IMAGES,Manifest.permission.READ_MEDIA_VIDEO}, ImagePicker.REQ_STORAGE);
                    return false;
                }
    ...
    private void gotoMeizuPermission() {
        try {
            ...
            intent.putExtra("packageName", "com.ajitmaurya.galleryimagepicker");
