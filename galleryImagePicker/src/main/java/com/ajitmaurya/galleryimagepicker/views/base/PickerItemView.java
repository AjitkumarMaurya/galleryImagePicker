package com.ajitmaurya.galleryimagepicker.views.base;
...
public abstract class PickerItemView extends PBaseLayout {
     ...
     * @param presenter    implements of {@link com.ajitmaurya.galleryimagepicker.presenter.IPickerPresenter}
     * @return 拍照
     */
     ...
     *
     * @param imageItem   当前图片
     * @param disableCode 不能选中的原因 {@link com.ajitmaurya.galleryimagepicker.bean.PickerItemDisableCode}
     */
